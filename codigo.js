window.onload = function () {
    ...
    function validate(e) {
        e.preventDefault();
        var patron = /^\s+/;
        var opciones = ["Chocolate", "Fresa", "Vainilla", "Mantecado", "Limón", "Grosella", "Rompope"];
    ...
    function showProducts() {
        if (selectElement.value == "Helado") {
            container2.textContent = "Chocolate (14.0), Vainilla (12.0), Fresa (9.98), Limón (6.0), Mantecado (7.5), Grosella (5.0), Rompope(5.7)";
        }
